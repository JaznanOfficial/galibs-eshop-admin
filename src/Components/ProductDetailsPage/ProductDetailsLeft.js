...
const ProductDetailsLeft = () => {
    return (
        <div >
            ...
            <div class="sm:w-full  md:w-11/12 px-5 mb-10 md:mb-0 border-2 border-green-200 flex justify-center items-center sm:mx-2 mx-12  ">
                <img
            ...
            <div className="flex sm:flex-row flex-col  gap-2 justify-center items-center  mt-5">
